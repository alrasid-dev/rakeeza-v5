...
export const ARABIC_FONT_LIBRARY: ArabicFontDef[] = [
  ...
  // Official Arabic font library names (Step 4) — alias proprietary/generic
  // names to their OFL TTF twins so they render + embed in PDF/Outlook.
  {
    id: 'Scheherazade',
    cssFamily: 'Scheherazade',
    label: 'Scheherazade (شهرزاد/رسمي)',
    category: 'serif-naskh',
    generic: 'serif',
    file: null,
    aliasFile: 'ScheherazadeNew-Regular.ttf',
    aliases: [],
    requiredForPdf: true,
  },
  {
    id: 'Kufi',
    cssFamily: 'Kufi',
    label: 'Kufi (كوفي/رسمي)',
    category: 'kufi',
    generic: 'sans-serif',
    file: null,
    aliasFile: 'ReemKufi-Regular.ttf',
    aliases: [],
    requiredForPdf: true,
  },
  {
    id: 'Naskh',
    cssFamily: 'Naskh',
    label: 'Naskh (نسخ/رسمي)',
    category: 'serif-naskh',
    generic: 'serif',
    file: null,
    aliasFile: 'NotoNaskhArabic-Regular.ttf',
    aliases: [],
    requiredForPdf: true,
  },
  {
    id: 'Lotus',
    cssFamily: 'Lotus',
    label: 'Lotus (لوتس/رسمي)',
    category: 'sans',
    generic: 'sans-serif',
    file: null,
    aliasFile: 'Cairo-Regular.ttf',
    aliases: [],
    requiredForPdf: true,
  },
  {
